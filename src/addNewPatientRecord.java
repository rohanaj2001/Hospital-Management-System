...
public class addNewPatientRecord extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:run
        String patientID = "";
        ...
        try{
            ...
            String q1 = "Select count(patientID) from patient";
            ...
            String query = "Insert into patient values('"+patientID+"','"+name+"','"+contactNumber+"','"+age+"','"+gender+"','"+bloodGroup+"','"+address+"','"+anyMajorDisease+"')";
            //ye sql k liye likha h tumne java me hume textfield k liye likhna pdega ki textfield empty nhi rhna chahiye
            
            if(name.isEmpty() || contactNumber.isEmpty() || age.isEmpty() || bloodGroup.isEmpty() || address.isEmpty()){
                JOptionPane.showMessageDialog(null,"Please provide all the details");
            }
            else{
                st.executeUpdate(query);
                JOptionPane.showMessageDialog(null,"Patient with id " + patientID + " Inserted Successfully");
            }
            setVisible(false);
